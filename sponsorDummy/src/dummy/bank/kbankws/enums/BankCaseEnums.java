...
public enum BankCaseEnums {
	...
	ENQUIRY_ACCOUNT_SUCCESS("ENQUIRY_ACCOUNT_BALANCE", "ENQUIRY_ACCOUNT_SUCCESS", "Enquiry Account Success","", "SUCCESS"),
	ENQUIRY_ACCOUNT_FAILED_ACC_NOT_REGISTER("ENQUIRY_ACCOUNT_BALANCE", "ENQUIRY_ACCOUNT_FAILED_ACC_NOT_REGISTER", "Account not register","102",	"FAILED"),
	ENQUIRY_ACCOUNT_ERROR_CANNOT_CONNECT("ENQUIRY_ACCOUNT_BALANCE", "ENQUIRY_ACCOUNT_ERROR_CANNOT_CONNECT", "Cannot connect Core Bank","999",	"ERROR"),
	...
	DRAWDOWN_FAILED_SPONSORCREDITLIMIT_NOT_REGISTER("DRAWDOWN", "DRAWDOWN_FAILED_SPONSORCREDITLIMIT_NOT_REGISTER", "SponsorCreditLimitAccount not register","102", "FAILED"),
	DRAWDOWN_FAILED_INSUFFICIENT_FUND("DRAWDOWN", "DRAWDOWN_FAILED_INSUFFICIENT_FUND", "Insufficient funds","", "FAILED"),
	DRAWDOWN_FAILED_INSUFFICIENT_SPONSORCREDITLIMIT("DRAWDOWN", "DRAWDOWN_FAILED_INSUFFICIENT_SPONSORCREDITLIMIT", "Insufficient Sponsor Credit limit","107", "FAILED"),
	DRAWDOWN_ERROR_CANNOT_CONNECT("DRAWDOWN", "DRAWDOWN_ERROR_CANNOT_CONNECT", "Cannot connect Core Bank","", "ERROR"),
	DRAWDOWN_FAILED_DUPLICATE_TRANSACTION("DRAWDOWN", "DRAWDOWN_FAILED_DUPLICATE_TRANSACTION", "Duplicate Transaction","E04","FAILED"),
	DRAWDOWN_FAILED_SOURCEACCSTATUS_NOT_ACTIVE("DRAWDOWN", "DRAWDOWN_FAILED_SOURCEACCSTATUS_NOT_ACTIVE", "SourceAccount Status is Suspend","103", "FAILED"),
	DRAWDOWN_FAILED_DESTACCSTATUS_NOT_ACTIVE("DRAWDOWN", "DRAWDOWN_FAILED_DESTACCSTATUS_NOT_ACTIVE", "DestinationAccount Status is Suspend","103", "FAILED"),
	DRAWDOWN_FAILED_SPONSORACCSTATUS_NOT_ACTIVE("DRAWDOWN", "DRAWDOWN_FAILED_SPONSORACCSTATUS_NOT_ACTIVE", "SponsorAccount Status is Suspend","103", "FAILED"),
	DRAWDOWN_FAILED_CANNOT_TRANSFER("DRAWDOWN", "DRAWDOWN_FAILED_CANNOT_TRANSFER", "Can not transfer funds","E03", "FAILED"),
