...
import dummy.bank.entity.ConfigApplication;
import dummy.bank.entity.LogTransaction;
...
public class LogTransactionController implements Serializable{
	...
	@JsonView({dummy.bank.entity.BankManageEvent.View.DetailForManageBank.class})
